...
public class FinishMeditationScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finish_meditation_screen);
        ...
        img_angry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FinishMeditationScreen.this, AngryScreen.class);
                intent.putExtra("cameFrom", "FinishMeditationScreen");
        ...
        img_happy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FinishMeditationScreen.this, HappyScreen.class);
                intent.putExtra("cameFrom", "FinishMeditationScreen");
                startActivity(intent);
                finish();
            }
        ...
        img_neutral.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FinishMeditationScreen.this, NeutralScreen.class);
                intent.putExtra("cameFrom", "FinishMeditationScreen");
                startActivity(intent);
                finish();
            }
        ...
        img_sad.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FinishMeditationScreen.this, SadScreen.class);
                intent.putExtra("cameFrom", "FinishMeditationScreen");
                startActivity(intent);
                finish();
            }
        ...
        img_very_happy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FinishMeditationScreen.this, VeryHappyScreen.class);
                intent.putExtra("cameFrom", "FinishMeditationScreen");
                startActivity(intent);
                finish();
            }
        ...
        btn_repeat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FinishMeditationScreen.this, MeditationScreen.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btn_done.setOnClickListener(view -> {
            Intent intent = new Intent(FinishMeditationScreen.this, DashboardScreen.class);
